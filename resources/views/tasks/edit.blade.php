                    ...
                    <form method="POST" action="{{ route('tasks.update', $task->id) }}">
                        ...
                        <div style="margin-bottom:20px;">
                            ...
                            <textarea id="description"
                                      ...
                                      style="width:100%;padding:12px 14px;border:1px solid #d1d5db;border-radius:10px;outline:none;resize:vertical;">{{ old('description', $task->description) }}</textarea>
                        </div>
                        ...
                        <div style="display:flex;gap:12px;flex-wrap:wrap;">
                            <button type="submit"
                                    style="background:#2563eb;color:white;padding:10px 20px;border:none;border-radius:10px;font-weight:600;cursor:pointer;">
                                Update Task
                            </button>
